...
public class IosHttpURLConnection extends HttpURLConnection {
   ...
   */
    private OutputStream nativeDataOutputStream;
   ...
   */
    ...
    private Object nativePipedRequestStream;
    ...
    private static final Comparator<String> HEADER_KEY_COMPARATOR = new Comparator<String>() {
    ...
    public OutputStream getOutputStream() throws IOException {
        ...
        if (chunkLength > 0) {
            ...
            if (nativePipedRequestStream == null) {
                nativePipedRequestStream = AsyncPipedNSInputStreamAdapter.create(requestStream, NATIVE_PIPED_STREAM_BUFFER_SIZE);
            }
            connect();
